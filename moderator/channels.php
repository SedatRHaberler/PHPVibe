...
<h3>Categories
<a class="btn btn-large btn-success mleft20" href="<?php echo admin_url('create-channel'); ?>"> Create new</a>
</h3>
<?php
if($channels) {
							 ...
							 <div class="inline-block img-hold">
                                <div class="inline-block right20 img-checker">
                                 <span class="pull-left mg-t-xs mg-r-md top20">
								  ...
								  <a class="btn btn-sm btn-outline btn-default confirm" href="<?php echo admin_url('channels');?>&p=<?php echo this_page();?>&delete-channel=<?php echo $video->cat_id;?>">
								  <i class="material-icons mright10"> delete </i><?php echo _lang("Delete"); ?>
								  </a>
								  <a class="btn btn-sm btn-default" href="<?php echo admin_url('edit-channel');?>&id=<?php echo $video->cat_id;?>">
								  <i class="material-icons mright10"> edit </i><?php echo _lang("Edit"); ?>
								  </a>	 			  
							      <a class="btn btn-sm btn-outline btn-default" target="_blank" href="#">
